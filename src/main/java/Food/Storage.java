    ...
    public static boolean removeFromStorage(int orderID){
        ...
        for(Object[] recipe : recipeInfo){
            ...
            for(Object[] ing : ingredients){
                ...
                if(!foodManagement.removeIngredientFromStorage((Integer)ing[3], (Integer)ing[1]*(Integer)recipe[1])){ //java.lang.ClassCastException: java.lang.String cannot be cast to java.lang.Integer(?)
                    return false;
                }
            }
